...
function OrderConfirmationMail(reciever, details) {
  ...
  tempOrderMain = tempOrderMain.replace("1NV01CEL1NK", "https://yumtrip.netlify.app/#/invoice/"+details[7].toString());
...
function OrderCancelledMail(reciever, details) {
  ...
  tempOrderMain = tempOrderMain.replace("1NV01CEL1NK", "https://yumtrip.netlify.app/#/invoice/"+details[3].toString());
